...
Features  <- subset(Features, Features$X0 != 'Diabetes_comorbidity')
Features  <- subset(Features, Features$X0 != 'Hypertension_comorbidity')
Features  <- subset(Features, Features$X0 != 'Ischemic_stroke_comorbidity')
Features  <- subset(Features, Features$X0 != 'RespirationRate')
Features  <- subset(Features, Features$X0 != 'Intracranial_hemorrhage_comorbidity')
Features  <- subset(Features, Features$X0 != 'Depression_comorbidity')
