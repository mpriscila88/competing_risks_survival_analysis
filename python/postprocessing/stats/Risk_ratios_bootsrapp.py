...
for outcome in outcomes:    
    ...
    for boot in range(0,1000):
        ...
        result_mat = sio.loadmat(f'{result_folder}/boot/bootstrapp_te_{boot}.mat')
        ...
        if boot == 999:
            ...
            df_m.to_csv(os.path.join(result_folder,f'risk_ratio_table_{outcome}_m.csv'), index=False)
            df_p.to_csv(os.path.join(result_folder,f'risk_ratio_table_{outcome}_p.csv'), index=False)   
